...
UI_TITLE = os.environ.get("UI_TITLE") or "ESTEE LAUDER CONSUMER FORESIGHT"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Foresight Room"
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "Ask anything about Global Serum Market for US, China, Korea & Japan"
)
